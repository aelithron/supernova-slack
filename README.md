...
1. Get your bot/alt account's user tokens. This generally involves logging onto Slack on an alt account, with a web browser.
  ...
  - While you're here, copy your main account (not the userbot account)'s Slack user ID!
...
2. Set up an app on [Slack's API portal](https://api.slack.com/apps). You can use the manifest in [`slack-manifest.json`](https://raw.githubusercontent.com/aelithron/supernova-slack/refs/heads/main/slack-manifest.json), feel free to change it as you wish.
  ...
  - Then, open the "Install App" tab from a page logged into your bot/alt account. Click "Install to (your workspace)", then approve the access. The page will give you your XOXP value at the top, and your XOXB value below it. Copy these.
